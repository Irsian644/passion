...
export async function createSignedUpload(
  ...
  // Server-side validation — the client's own check is only for fast feedback
  // and cannot be trusted. No size limit: the client uploads their own photos
  // at whatever size their phone or camera produced. The bucket's own
  // file_size_limit remains the backstop against a runaway upload.
